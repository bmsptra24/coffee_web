<?php // app/Views/admin/menus/create.php
...
<div class="bg-white p-8 rounded-2xl border-2 border-gray-200 max-w-2xl mx-auto">
    <form action="<?= site_url('admin/menus/store') ?>" method="post" enctype="multipart/form-data">
        <div class="mb-6">
        ...
        <div class="mb-6">
            ...
            <textarea id="description" name="description" rows="5"
                class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 text-gray-700 leading-tight
                       focus:outline-none focus:ring-4 focus:ring-accent-gold focus:border-transparent transition duration-300"
                placeholder="Deskripsi singkat tentang menu"><?= old('description') ?></textarea>
        </div>

        <div class="mb-6">
            <label for="price" class="block text-gray-800 text-base font-semibold mb-2">Harga (Rp):</label>
            <input type="number" id="price" name="price" value="<?= old('price') ?>" step="any"
                class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 text-gray-700 leading-tight
                       focus:outline-none focus:ring-4 focus:ring-accent-gold focus:border-transparent transition duration-300"
        ...
        <div class="mb-8">
            <label for="image" class="block text-gray-800 text-base font-semibold mb-2">Gambar Menu:</label>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-end gap-4">
            ...
            <button type="submit" class="bg-primary-coffee hover:bg-accent-gold hover:text-primary-coffee
                ...
                Simpan Menu <span class="ml-2">&#x27A4;</span>
            </button>
        </div>
    </form>
</div>
